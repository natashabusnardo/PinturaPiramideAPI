...
<head>
    <meta charset="UTF-8">
    <title>Pintura da Pirâmide</title>
    <!-- Fonts -->
        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center pt-8 sm:justify-start sm:pt-0">
                <div class="px-4 text-lg text-gray-500 border-r border-gray-400 tracking-wider">
                    <?php
                        $g = areaLateral($h, $ab);
                        $qtdlitro = litrosTinta(areaTotal($g, $ab));
                        $qtdlata = latasTinta($qtdlitro);
                        echo "<h1>Pintura da pirâmide</h1> <br>"
                        . "ab: " . $ab . " <br>"
                        . "h: " . $h . " <br>"
                        . "al: " . $g . " <br>"
                        . "Área Triangulo: " . areaTriangulo($g, $ab) . " <br>"
                        . "Área Base: " . areaBase($ab) . " <br>"
                        . "Área Total: " . areaTotal($g, $ab) . " <br>"
                        . "Tipo de Tinta: " . $tt . " <br>"
                        . "Litros: " . $qtdlitro . " <br>"
                        . "Latas: " . $qtdlata . " <br>"
                        . "Preço: " . valorTinta($qtdlata, $tt) . " <br>"
                        . "Volume: " . volumePiramide($ab, $h) . " <br>"
